...
class game:
    ...
    #-------------------------
        ...
        self.__onScreenSurface = (pygame.display.set_mode(windowSize, pygame.FULLSCREEN))
        # Surface du plateau
    ...
    #-------------------------
        ...
        pygame.init()
        self.__onScreenSurface.fill(black)
        self.__onScreenSurface.blit(self.__tableSurface, (x, y))
                ...
                if i % 2 == 0:  # si la ligne est paire on va placer une case pion puis une case barrier vertical
                    if self.__grid[i][j * 2].getPawn() == True:
                        if self.__grid[i][j * 2].getPlayer() == 1:
                            ...
                            pygame.draw.rect(self.__tableSurface, green, pygame.Rect(j * 75, i / 2 * 75, 50, 50))
                        elif self.__grid[i][j * 2].getPlayer() == 4:
                            pygame.draw.rect(self.__tableSurface, yellow, pygame.Rect(j * 75, i / 2 * 75, 50, 50))
                    else:
                        if self.pawnVerification(j*2,i) == True:
                            if self.__currentPlayer == 1 :
                                pygame.draw.rect(self.__tableSurface, light_Blue, pygame.Rect(j * 75, i / 2 * 75, 50, 50))
                            elif self.__currentPlayer == 2 : 
                                pygame.draw.rect(self.__tableSurface, light_Red, pygame.Rect(j * 75, i / 2 * 75, 50, 50))
                            elif self.__currentPlayer == 3 : 
                                pygame.draw.rect(self.__tableSurface, light_Green, pygame.Rect(j * 75, i / 2 * 75, 50, 50))
                            elif self.__currentPlayer == 4 : 
                                pygame.draw.rect(self.__tableSurface, light_Yellow, pygame.Rect(j * 75, i / 2 * 75, 50, 50))
                    ...
                    if self.__grid[i][j * 2].getBarrier() == True:
                        ...
                        pygame.draw.rect(self.__tableSurface, grey, pygame.Rect(j * 75, i / 2 * 75 + 12.5, 50, 25))
                    if j != len(self.__grid) // 2:
