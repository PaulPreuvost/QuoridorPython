...
>>>>>>> 3090eb30653abd16678d7206ce0d75a660f5ab28
import serveur
import client
...
=======
                    return self.__grid[y + 2][
                        x].getBarrier() == 0  # verifie 2 case apres si elle est vide (car le coin compt comme une case)
                else:
                    return self.__grid[y][
                        x + 2].getBarrier() == 0  # verifie 2 case en dessous si elle est vide (car le coin compt comme une case)
        else:
            print("false bank")
            return False
>>>>>>> 3090eb30653abd16678d7206ce0d75a660f5ab28
...
=======
        co = [self.__pawnCoordinate[case_pawn(False, self.__curren_player).color()][0],
              self.__pawnCoordinate[case_pawn(False, self.__curren_player).color()][1]]
        possibleCase = (
        [0, 2], [2, 0], [0, -2], [-2, 0], [-2, 2], [2, 2], [2, -2], [-2, -2], [0, 4], [4, 0], [0, -4], [-4, 0])
...
=======
                    if self.__grid[co[0] - possiblecase_barrier[index][0]][
                        co[1] - possiblecase_barrier[index][1]].getBarrier() == False:
                        return True

                elif index > 7:  # verrif du saut de joueur
                    if self.__grid[co[0] - possiblecase_barrier[index - 8][0]][
                        co[1] - possiblecase_barrier[index - 8][1]].getBarrier() == False:
                        if self.__grid[co[0] - possibleCase[index - 8][0]][
                            co[1] - possibleCase[index - 8][1]].getPawn() == True:
                            if self.__grid[co[0] - possiblecase_barrier[index - 4][0]][
                                co[1] - possiblecase_barrier[index - 4][1]].getBarrier() == False:
                                return True
...
=======
            ...
            if self.__grid[co[0] - 1][co[1]].getBarrier() == False:
                if self.__grid[co[0] - 2][co[1]].getPawn() == True:
                    if self.__grid[co[0] - 3][co[1]].getBarrier() == True or self.__grid[co[0] - 4][
                        co[1]].getPawn() == True:
                        nord = True
        else:
            if self.__grid[co[0] + 1][co[1]].getBarrier() == False:
        ...
        if check2 == "est":
            if self.__grid[co[0]][co[1] + 1].getBarrier() == False:
                if self.__grid[co[0]][co[1] + 2].getPawn() == True:
                    if self.__grid[co[0]][co[1] + 3].getBarrier() == True or self.__grid[co[0]][
                        co[1] + 4].getPawn() == True:
                        est = True
        else:
            if self.__grid[co[0]][co[1] - 1].getBarrier() == False:
...
=======
        ...
        self.__grid[self.__pawnCoordinate[case_pawn(False, self.__curren_player).color()][0]][
            self.__pawnCoordinate[case_pawn(False, self.__curren_player).color()][1]] = case_pawn(False, 0)
